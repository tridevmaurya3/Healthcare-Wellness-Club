...
<div class="os-footer-note"><strong>Cost rule:</strong> entering a unit cost here does not automatically become Business OS profit cost unless you explicitly select the checkbox.</div></main></div><script src="assets/business-collapsible.js?v=20260820-1" defer></script></body></html>
